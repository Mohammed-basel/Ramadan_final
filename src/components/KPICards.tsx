    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 flex items-center gap-4 hover:shadow-xl transition-shadow">
          ...
          <div className="text-right flex-1 min-w-0">
            <h3 className="text-gray-700 font-bold text-base mb-1">{t(lang, 'highestIncrease')}</h3>
            ...
            <p className="text-xs text-gray-500 mt-1">عن الإرشادي - أسبوع {currentWeek}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 flex items-center gap-4 hover:shadow-xl transition-shadow">
          ...
          <div className="text-right flex-1 min-w-0">
            <h3 className="text-gray-700 font-bold text-base mb-1">{t(lang, 'largestDecrease')} </h3>
            <p className="text-lg font-bold text-gray-800 mb-1 truncate">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 flex items-center gap-4 hover:shadow-xl transition-shadow">
          ...
          <div className="text-right flex-1 min-w-0">
            <h3 className="text-gray-700 font-bold text-base mb-2">{t(lang, 'methodology')}</h3>
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b">
              <h3 className="text-xl font-black text-gray-800">{t(lang, 'methodology')}</h3>
              <button
                type="button"
                onClick={() => setOpenMethodology(false)}
